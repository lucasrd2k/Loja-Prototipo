    ...
    <main>
        ...
        <div class="container mt-4">
            ...
            <div class="text-center darken-grey-text mb-4">
                <h1 class="font-bold mt-4 mb-3 h3" style="color: #1C1C1C;">PESQUISE PELO NOME DO ADMIN</h1>
            </div>
            <div class="card mb-4">
                <div class="card-body">
                    <!-- Grid row -->
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody style="text-align:center;">
                            <tr>
                                ...
                                <td><a class="btn btn-info"><i class="material-icons">edit</i></a></td>
                                <td><a class="btn btn-danger" href="deletar_admin.php?id=<?php echo $dados["id"];?>"><i class="material-icons">delete</i></a></td>
                            </tr>
                        </tbody>
                        <?php } ?>
                        <!--Table body-->
